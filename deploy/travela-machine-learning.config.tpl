...
SECRETS=('travela-machine-learning' 'travela-tls' 'travela.sql')

# List of files ending in '.service.yml' in the kube directory
SERVICES=('travela-machine-learning')
...
DEPLOYMENTS=('travela-machine-learning')
...
BLOCKING_JOBS=('travela-machine-learning')
